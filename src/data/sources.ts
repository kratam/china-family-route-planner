...
export const sources = {
  ...
  railGuilinCAN: { label: "Guilin–Guangzhou HSR – jelenlegi menetrend", url: "https://www.travelchinaguide.com/china-trains/high-speed/guangzhou-guilin.htm" },
  railXiamenCAN: { label: "Xiamen–Guangzhou HSR – élő kereső", url: "https://www.trip.com/trains/china/route/xiamen-to-guangzhou/" },
  railChaoshanCAN: { label: "Chaoshan–Guangzhou vasút – élő kereső", url: "https://www.trip.com/trains/china/route/chaoshan-to-guangzhou/" },
  flightBUDSZX: { label: "BUD–SZX aktuális közvetlen menetrend", url: "https://www.directflights.com/BUD-SZX" },
  ...
  flightHKGSanya: { label: "HKG–SYX aktuális közvetlen járatok", url: "https://www.directflights.com/HKG-SYX" },
  flightSYXCAN: { label: "SYX–CAN aktuális közvetlen járatok", url: "https://www.directflights.com/SYX-CAN" },
  flightDADHAN: { label: "DAD–HAN aktuális közvetlen járatok", url: "https://www.directflights.com/DAD-HAN" },
  flightDYGCAN: { label: "DYG–CAN aktuális közvetlen járatok", url: "https://www.directflights.com/DYG-CAN" },
  flightHANBUD: { label: "HAN–BUD egyátszállásos útvonalak", url: "https://www.flightconnections.com/flights-from-han-to-bud" },
  railZhaoqingSZ: { label: "Shenzhen–Zhaoqing vasút – élő kereső", url: "https://www.trip.com/trains/china/route/shenzhen-to-zhaoqing/" },
  railXiamenSZ: { label: "Xiamen–Shenzhen HSR – élő kereső", url: "https://www.trip.com/trains/china/route/xiamen-to-shenzhen/" },
  railChaoshanHK: { label: "MTR Hongkong–Chaoshan (2026. júl.)", url: "https://www.highspeed.mtr.com.hk/en/trip-planner.html?id=WEK2CHS" },
  flightSYXSZX: { label: "SYX–SZX közvetlen járatok", url: "https://www.directflights.com/SYX-SZX" },
  roadDapeng: { label: "Dapeng-félsziget – transzfer és programkereső", url: "https://www.klook.com/en-US/search/?query=Dapeng%20Peninsula%20Shenzhen" },
  flightBUDPVG: { label: "Budapest–Shanghai közvetlen járat – Trip.com", url: "https://us.trip.com/flights/budapest-to-shanghai/tickets-bud-sha" },
  flightPVGBUD: { label: "Shanghai–Budapest közvetlen járat – Trip.com", url: "https://us.trip.com/flights/shanghai-to-budapest/tickets-sha-bud" },
  flightPVGTSA: { label: "Shanghai–Tajpej (Songshan) közvetlen járat – Trip.com", url: "https://us.trip.com/flights/shanghai-to-taipei/tickets-sha-tsa" },
  railTHSR: { label: "Tajvani gyorsvasút (THSR) – hivatalos menetrend és jegyek", url: "https://en.thsrc.com.tw/" },
  ferryXiaoliuqiu: { label: "Xiaoliuqiu komp és sziget – útmutató", url: "https://www.nickkembel.com/xiaoliuqiu-lambai-island-taiwan/" },
