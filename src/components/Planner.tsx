...
export function Planner() {
  ...
  const winningScore = scoreItinerary(itineraries.find((route) => route.id === "shenzhen-return") ?? itineraries[0]).toFixed(1).replace(".", ",");
  return <>
    <header className="site-header"><a className="brand" href="#top">KELETI <i>IRÁNYTŰ</i></a><nav><a href="#osszehasonlitas">Célpontok</a><a href="#rangsor">Rangsor</a><a href="#utvonalak">Útvonalak</a><a href="#repules">Repülés</a><a href="./repuloarak/" className="nav-cta">Repülőárak</a></nav><span className="verified">Adatok ellenőrizve: 2026. augusztus</span></header>
    <main id="top">
      <section className="hero"><img src="./photos/guilin-1.jpg" alt="A Li folyó karszthegyei Guilin és Yangshuo között" /><div className="hero-shade" /><div className="hero-content"><span className="hero-kicker">Családi útikalauz · 2026 ősz</span><h1>Mit nézzünk meg<br /><em>Shenzhen mellett?</em></h1><p>Kína és Délkelet-Ázsia 8 és 10 éves gyerekkel – természet, történelem, aktív programok és tenger</p><div className="hero-actions"><a href="#ajanlas" className="primary">Mutasd a győztest</a><a href="#osszehasonlitas">22 célpont összevetése</a></div></div><a className="scroll-cue" href="#ajanlas" aria-label="Ugrás a legjobb ajánláshoz"><ChevronDown /></a></section>
      <section className="verdict-band" id="ajanlas"><div><span>🥇 LEGJOBB ÖSSZESSÉGÉBEN</span><h2>Shenzhen oda-vissza + Hongkong + Guilin/Yangshuo</h2><p>Ugyanaz a program, mint a guangzhoui open-jaw ívnél, csak Guilinből vonattal jövünk vissza Shenzhenbe. A 2026. augusztus 27-i árlekérdezés szerint ez <strong>752 euróval olcsóbb</strong>, egyetlen jegyen van, és <strong>oda is, vissza is közvetlen</strong>.</p><p className="verdict-cta"><a href="./repuloarak/">Nézd meg a konkrét, lekérdezett repülőárakat →</a></p></div><div className="verdict-stats"><div><strong>{winningScore}</strong><span>összpont / 5</span></div><div><strong>3 016 €</strong><span>repülő / 4 fő</span></div><div><strong>0</strong><span>átszállás és regionális repülés</span></div></div></section>
      ...
      <section className="final-picks"><div className="section-kicker">Saját ajánlás</div><h2>Ha ma kellene foglalnom</h2><div className="pick-grid"><article className="pick-winner"><span>🥇 Legjobb összességében</span><h3>Shenzhen oda-vissza + Hongkong + Guilin/Yangshuo</h3><p>Mert a két hét minden fontos célját teljesíti regionális repülés nélkül, és a lekérdezett árak szerint ez az egyetlen mindkét irányban közvetlen megoldás – ráadásul a legolcsóbb is.</p></article><article><span>🌄 Legjobb természet</span><h3>Guilin / Yangshuo</h3><p>Nem egyetlen panoráma: hajó, tutaj, bicikli, barlang és falvak négy napon át.</p></article><article><span>🏯 Legjobb történelem</span><h3>Siem Reap / Angkor</h3><p>Ha vállaljuk a gyengébb repülési logisztikát, semmi más nem ad ekkora történelmi felfedezésélményt.</p></article><article><span>🚆 Legjobb repülés nélküli</span><h3>Hongkong + Guilin</h3><p>A háromórás közvetlen vonat a teljes régió egyik legjobb idő/élmény aránya.</p></article><article><span>💰 Legjobb ár/érték</span><h3>Chaozhou</h3><p>Két éj, gyors vonat, erős történelem és kiváló konyha – kis kockázat, nagy karakter. Repülőben ugyanaz a 3 016 €, ha Shenzhenbe zárjuk az utat.</p></article><article><span>👨‍👩‍👧‍👦 Legjobb gyerekekkel</span><h3>Hongkong</h3><p>Felvonó, komp, strand, könnyű túra, Disneyland és Ocean Park egyetlen hotelből.</p></article></div></section>
    </main>
