...
export function Planner() {
  ...
  return <>
    ...
    <main id="top">
      ...
      <section className="editorial-section comparison-section" id="osszehasonlitas"><div className="section-kicker">Gyors összehasonlítás</div><h2>Minden szóba jövő hely, egy nézetben</h2><p className="section-lead">A költségek tervezési sávok, nem élő ajánlatok. Mobilon a táblázat a saját keretében görgethető.</p><FilterBar selected={selected} onToggle={toggle} onClear={() => setSelected([])} /><div className="result-count" aria-live="polite">{visible.length} célpont látható</div><Comparison destinations={visible} /></section>
