...
export function Comparison({ destinations }: { destinations: Destination[] }) {
  return <div className="comparison-wrap">
    <table className="comparison-table">
      <thead><tr><th>Hely</th><th>Ország</th><th>Shenzhenből</th><th>Hongkongból</th><th>Vonat</th><th>Repülő</th><th>Reális idő</th><th>Kb. költség / fő</th><th>Történelem</th><th>Természet</th><th>Aktív</th><th>Fürdés</th><th>Gyerek</th><th>Időjárás</th><th>Éjszaka</th><th>Wow</th></tr></thead>
